...
public class CompexMovingAverageIndicator {
	...
	public void calculateComplexMovingAverage(int firstPeriod, int secondPeriod, int thirdPeriod, StockTickerHistory tickerCollection){
		...
		secondAverageIndicator.calculateSimpleMovingAverage(firstPeriod, tickerCollection);
		thirdAverageIndicator.calculateSimpleMovingAverage(firstPeriod, tickerCollection);
