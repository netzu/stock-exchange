...
public class ComplexMovingAverageSignals {
	...
	private void complexBuySignal(ComplexMovingAverageIndicator averageCollection, StockTickerHistory stockCollection){
	...
	private void complexSellSignal(ComplexMovingAverageIndicator averageCollection, StockTickerHistory stockCollection){
		SimpleMovingAverageSignals firstSignals = new SimpleMovingAverageSignals();
		SimpleMovingAverageSignals secondSignals = new SimpleMovingAverageSignals();
		SimpleMovingAverageSignals thirdSignals = new SimpleMovingAverageSignals();
	...
	public void generateComplexSignals(ComplexMovingAverageIndicator averageCollection, StockTickerHistory stockCollection){
