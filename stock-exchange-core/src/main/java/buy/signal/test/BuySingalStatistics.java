...
public class BuySingalStatistics {
	...
	public String printStatsToString() {
		String stats = getSumOfProfits() + ";" + getSumOfPercentage() + ";"
				+ getAverage() + ";" + getStandardDeviation() + ";"
				+ getMedian() + ";" + getVariance() + ";" + getMin() + ";"
				+ getMax() + ";" + getSumNegativeProfits() + ";"
				+ getSumPositiveProfits() + ";" + getCountNegativeProfits()
